    ...
    <div class="max-w-6xl mx-auto">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-16 mb-12">
        ...
        <div>
          ...
          <div class="flex flex-wrap gap-3">
            <a
              ...
              class="inline-flex items-center gap-2 h-9 px-3 rounded border border-[var(--sw-border)] text-sm text-[var(--sw-text-2)] hover:text-[var(--sw-text-1)] hover:bg-[var(--sw-surface-2)] transition-colors focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-[var(--sw-focus-ring)] motion-reduce:transition-none"
            >
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-10">
          ...
          <div>
            <h3 class="text-sm font-semibold text-[var(--sw-text-1)] mb-3">Book a Talk</h3>
      ...
      <!-- Bottom bar -->
      <div class="border-t border-[var(--sw-border)] pt-6 flex flex-col sm:flex-row justify-between items-center gap-2">
        <p class="text-xs text-[var(--sw-text-3)]">© {{ YEAR }} Nerando Johnson. All rights reserved.</p>
        <p class="font-mono text-xs text-[var(--sw-text-3)]">Made with <a href="https://revealjs.com" target="_blank" rel="noopener noreferrer" class="text-[var(--sw-primary)]">Reveal.js</a></p>
      </div>
    </div>
  </footer>
</template>
