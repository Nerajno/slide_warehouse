...
const recentTalkSlideCount = computed(() => {
  const deck = allDecks.value?.find((d: DeckFrontmatter) => d.id === speaker.value?.recentTalk?.deckSlug)
        ...
        <div class="p-4 flex flex-col flex-1">
          ...
          <div class="mt-auto flex items-center justify-between text-xs border-t border-gray-800 pt-3">
            ...
            <div class="flex items-center gap-3 shrink-0">
              <a
                v-if="speaker.recentTalk.recordingUrl"
                :href="speaker.recentTalk.recordingUrl"
                target="_blank"
                rel="noopener"
